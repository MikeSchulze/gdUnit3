...
const __source = 'res://addons/gdUnit3/src/fuzzers/StringFuzzer.gd'
...
func test_next_value() -> void:
	...
	for i in 100:
		...
		# using regex to remove all expected chars to verify the value only containing expected chars by is empty
