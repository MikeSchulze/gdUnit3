...
func test_is_test_suite() -> void:
	...
	#assert_bool(GdObjects.is_test_suite(GdUnitTestResourceLoader.load_cs_script("res://addons/gdUnit3/mono/test/core/resources/testsuites/NotATestSuite.cs"))).is_false()
