...
const __source = 'res://addons/gdUnit3/src/report/JUnitXmlReport.gd'
...
func test_to_ISO8601_datetime() -> void:
	var date = {
		"year" : 2022, 
		"month" : 05,
		"day": 10,
	...
	assert_str(JUnitXmlReport.to_ISO8601_datetime(date)).is_equal("2022-05-10T12:23:50")
